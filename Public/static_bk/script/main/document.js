            ...
            Doc = {
                ...
                "init": function () {
                    ...
                    $copylink.find("a").zclip({
                        ...
                        "copy": function () {
                            return $menu.find("li.active > div a")[0].href;
                        },
                        "afterCopy": function () {
                        }
                    });
                ...
                "prettify": function () {
                    ...
                    $code.find(".copycode a").zclip({
                        ...
                        "copy": function () {
                            return $(this).closest("pre").data("code")
                        },
                        "afterCopy": function () {
                        }
                ...
                "load": function (name) {
                    ...
                    if (name != this.article.data("name")) { //非当前页则加载数据
                        ...
                        //} else {
                            ...
                            //}, "json");
                            if ($item.children("div").find("a").attr("href") == (window.location.pathname+'?s=/BkHome/Login/loginout')) {
                                location.href = $item.children("div").find("a").attr("href");
                                return;
                            }
                            $.post($item.children("div").find("a").attr("href"), {searchname: searchname}, function (data) {
                                success(data); //渲染数据
                                $item.data("article", data); //缓存数据
                            }, "html");
                        //}
                        ...
                        $("title").text($item.children("div").text());
                    }
